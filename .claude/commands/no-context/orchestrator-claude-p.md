...
2. Read the POML behavior file at `poml/commands/no-context/orchestrator-claude-p.poml` using `poml --file <filename>`
...
Then I'll read and convert the POML file using `poml --file poml/commands/no-context/orchestrator-claude-p.poml` to understand what Layer 2 commands to execute.
